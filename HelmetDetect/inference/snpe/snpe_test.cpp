...
#include "RunSnpe/snpe_inference.hpp"
#include "../common.h"
...
{
    ai2nference::InferSNPE* snpe_inference = new ai2nference::InferSNPE(argv[1],ai2nference::DataFormat::NHWC);
    snpe_inference->initRuntime(ai2nference::RunTime::CPU);
